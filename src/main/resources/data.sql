...
-- INSERT PROJECTS			
insert into project (project_id, name, stage, description, start_date, end_date) values (1000, 'Large Production Deploy', 'NOTSTARTED', 'This requires all hands on deck for the final deployment of the software into production', Date '2020-9-5', Date '2020-9-12');
insert into project (project_id, name, stage, description, start_date, end_date) values (1001, 'New Employee Budget',  'COMPLETED', 'Decide on a new employee bonus budget for the year and figureout who will be promoted', Date '2020-9-15', Date '2020-9-30');
insert into project (project_id, name, stage, description, start_date, end_date) values (1002, 'Office Reconstruction', 'COMPLETED', 'The office building in Monroe has been damaged due to hurricane in the region. This needs to be reconstructed', Date '2020-10-24', Date '2020-10-25');
insert into project (project_id, name, stage, description, start_date, end_date) values (1003, 'Improve Intranet Security', 'INPROGRESS', 'With the recent data hack, the office security needs to be improved and proper security team needs to be hired for implementation', Date '2020-10-2', Date '2020-10-10');
